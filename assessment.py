...
def words_in_common(words1, words2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    return sorted(list(set(words1).intersection(set(words2))))
   # takes first list, makes it into a set. finds intersections (common words) w/ 2nd list
   # then makes common words found into a list, so it can be sorted alphabetically. 
...
def smallest_n_items(items, n):
    ...
    """
    return list(reversed(sorted(items)[:n]))
